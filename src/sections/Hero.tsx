...
<div className="container">
  ...
  <div className="w-[478px]">
    ...
    <p className="text-xl tracking-tight mt-6 text-[#010D3E]">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis ipsum sit velit, quam deleniti cumque suscipit vitae. Ad deleniti ducimus, fugiat, minus nisi vero repellendus laboriosam quod ipsum, magnam nesciunt!</p>
